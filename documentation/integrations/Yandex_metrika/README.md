...
Инструкция по настройке целей на стороне Яндкс.Метрики : github.com/yuferev/callkeeper/blob/master/documentation/callkeeper_events/events-Metrika/README.md
