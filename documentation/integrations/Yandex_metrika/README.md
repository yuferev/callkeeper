...
Для отправки событий в Яндекс.Метрику необходимо выбрать цель если это необходимо. Если цели нет в личном кабинете Яндекс.Метрики её необходимо создать:
...
Это позволит отправлять в счетчик Яндекс.Метрики информацию по событиям : открытие виджета , переход на сайт , заказ звонка , закрытие виджета и т.д
