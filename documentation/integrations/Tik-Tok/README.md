...
Такие звонки по формам из TikTok будут считаться обратными звонками. Отчет и вся информация по ним будет передаваться и отображаться в личном кабинете CallKeeper во вкладке «Звонки».

Уже в личном кабинете CallKeeper все звонки можно отфильтровать по нужным параметрам во вкладке «Звонки» - «Фильтр»:

![Рис.20](images/filtr.jpg)

![Рис.21](images/filtr_12.jpg)

Доступна детальная информация по каждому звонку как показано ниже:
