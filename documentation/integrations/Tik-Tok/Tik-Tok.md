...
1) Аккаунт пользователя в TikTok и аккаунт рекламодателя TikTok For Business
...
(Галочки в данном окне убирать не нужно)
 ...
 Затем вас автоматически перенаправит в личный кабинет , где можно продолжить процесс настройки. Необходимо будет выбрать аккаунт и настроить форму.
