...
- Убедитесь, что у вас есть [необходимый доступ](#Страница-Facebook-роли). Если с правами и доступом все в порядке,  попробуйте обратиться в техническую поддержку Facebook. 

**8. На первом этапе подключения нет нужных мне страниц**

- Убедитесь, что у вас есть [необходимый доступ](#Страница-Facebook-роли). 
