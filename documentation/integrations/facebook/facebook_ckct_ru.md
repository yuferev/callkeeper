...
- Форма, на которую вы заказываете лид, может быть выключена в личном кабинете. [Убедитесь](#Чтобы-форма-работала-переведите-ползунок-напротив-формы-вправо-в-активное-состояние), что ползунок рядом с формой находится в активном положении и попробуйте заново заказать лид.
