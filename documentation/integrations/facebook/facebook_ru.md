...
![Рис.20](images/ck_facebook.png)

В открывшейся вкладке нажмите «Подключить».

![Рис.21](images/ck_facebook_1.png)
...
![Рис.27](images/ck_add_account_1.jpg)
...
![Рис.30](images/ck_add_account_7.jpg)
...
![Рис.31](images/ck_account_access_granted.png)

Пример 2. Проблемы с доступом ко всем сущностям – аккаунту, странице и форме.

![Рис.32](images/ck_account_access_denied.png)
