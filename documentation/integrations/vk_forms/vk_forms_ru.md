...
Заполните название формы и прикрепить к ней виджет.

- Название поля с номером телефона - точное название поля, в котором пользователь будет набирать свой номер.
