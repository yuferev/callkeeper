...
Вы также можете настроить подмену номера с помощью поиска по маске.

Если вы используете номера коллтрекинга не на сайте, то вы можете заполнить поле произвольным образом, в таком случае параметр не скажется на работе сервиса.
...
В открывшейся вкладке выберите один из ранее созданных офисов, заполните селектор блоков для разметки телефонов (или же воспользуйтесь полем для ввода номера для замены по маске) и выберите один или несколько подменных номеров и нажмите на кнопку «Добавить».
...
![Рис.33](images/webhook_query_names.png)
...
[Вернуться к оглавлению](#работа-с-сервисом-calltracking)
