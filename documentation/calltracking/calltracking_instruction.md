...
**utm-метки** - вы можете настроить правило срабатывания кампании по определенным utm-меткам. Выберите нужную utm-метку, пропишете ее значение и нажмите "Добавить".
