...
Referral - в значении прописывается адрес сайта, переход с которого попадет под это правило. Если вы хотите отслеживать посетителей с партнерских или поисковых сайтов, то вам нужно настроить правило с этим значением.

![Рис.15.1](images/rules_yandex.png)

Отслеживание посетителей, пришедших с yandex.ru.

![Рис.15.2](images/rules_yandex_google.png)

Отслеживание посетителей, пришедгих с yandex.ru или google.com.
...
Не рекомендуется ставить продолжительность сессии больше 10 минут. Слишком большое время сессии может привести к тому, что все подменные номера будут выданы посетителям и останутся закрепленными за ними в течение долгого времени. Новым посетителям не будет хватать подменных номеров и они будут получать номер-заглушку.
